...
Ruff and mypy: 1315 passed / 1 skipped locally (optional PyArrow present); under
...
stays v16 (migration `d016_kalshi_matching`); **Phase E has not started.**
...
performed; D5A canonical team/player/venue/official-game matching is complete (deterministic alias + official-schedule evidence, mocked/offline); D5B1 sportsbook-event matching is complete (migration `d015_sportsbook_matching`, mocked/offline); D5B2 Kalshi event + game-winner market matching is complete (schema v16, migration `d016_kalshi_matching`; mocked/offline plus a bounded public-contract audit and parser smoke); Phase E has not started. The live MLB provider audit and
...
no persisted weather ingestion or backfill). D5A canonical team/player/venue/official-game matching is complete (deterministic alias + official-schedule evidence, mocked/offline); D5B1 sportsbook-event matching is complete (migration `d015_sportsbook_matching`, mocked/offline); D5B2 Kalshi event + game-winner market matching is complete (schema v16, migration `d016_kalshi_matching`; mocked/offline plus a bounded public-contract audit and parser smoke); Phase E has not started.
...
was performed. Phase E has not started.**
...
> verified; no persisted weather ingestion/backfill); D5A canonical team/player/venue/official-game matching is complete (deterministic alias + official-schedule evidence, mocked/offline); D5B1 sportsbook-event matching is complete (migration `d015_sportsbook_matching`, mocked/offline); D5B2 Kalshi event + game-winner market matching is complete (schema v16, migration `d016_kalshi_matching`; mocked/offline plus a bounded public-contract audit and parser smoke); Phase E has not started. The

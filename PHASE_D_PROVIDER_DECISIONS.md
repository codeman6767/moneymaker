...
> ingestion). D5 entity matching is complete through D5B2 (schema v16, mocked/offline plus a bounded public-contract audit); Phase E has not started, and any large backfill still requires an approved

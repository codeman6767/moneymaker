...
> ingestion). D5 entity matching is complete through D5B2 (schema v16, mocked/offline plus a bounded public-contract audit); Phase E1 is complete (independently reviewed) and Phase E2 (dataset + quality commands) is implemented (independent review pending); any large backfill still requires an approved

...
#: The schema version a freshly initialized database reaches (migration f021).
CURRENT_SCHEMA_VERSION: Final = 21
#: Versions the tooling accepts on an EXISTING database. e017, f018, f019 and
#: f020 and f021 are all purely additive -- they create only new append-only tables and triggers
...
SUPPORTED_SCHEMA_VERSIONS: Final = frozenset(
    {16, 17, 18, 19, 20, CURRENT_SCHEMA_VERSION})
